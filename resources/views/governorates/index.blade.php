...
@section('content')
    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{url(route('governorates.create'))}}" class="btn btn-primary mb-3"> <i class="fa fa-plus"> </i> Add Governorate</a>
                @if(count($records))
                                ...
                                @foreach($records as $record)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url(route('governorates.edit',$record->id))}}" class="btn btn-success btn-xs" class="fa fa-edit"> Edit </a>
                                        </td>
