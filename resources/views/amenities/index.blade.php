...
@section('content')
    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{url(route('amenities.create'))}}" class="btn btn-primary mb-3"> <i class="fa fa-plus"> </i> Add Category</a>
                @if(count($records))
                                ...
                                @foreach($records as $record)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url(route('amenities.edit',$record->id))}}" class="btn btn-success btn-xs" class="fa fa-edit"> Edit </a>
                                        </td>
                                        <td class="text-center">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form role="form" action="{{url(route('amenities.destroy',$record->id))}}" class="" method="POST">
