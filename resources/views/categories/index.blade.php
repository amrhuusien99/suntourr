...
@section('content')
    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{url(route('categories.create'))}}" class="btn btn-primary mb-3"> <i class="fa fa-plus"> </i> Add Category</a>
                @if(count($records))
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form role="form" action="{{url(route('categories.destroy',$record->id))}}" class="" method="POST">
