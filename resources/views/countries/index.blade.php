...
@section('content')
    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{url(route('countries.create'))}}" class="btn btn-primary mb-3"> <i class="fa fa-plus"> </i> Add Country</a>
                @if(count($records))
                                ...
                                @foreach($records as $record)
                                    <tr id="removable{{$record->id}}">
                                        ...
                                        <td class="text-center">
                                            <a href="{{url(route('countries.edit',$record->id))}}" class="btn btn-success btn-xs" class="fa fa-edit"> Edit </a>
                                        </td>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form role="form" action="{{url(route('countries.destroy',$record->id))}}" class="" method="POST">
                                        ...
                                        <!-- <td class="text-center">
                                            {!! Form::open([
                                                'action' => ['CountriesController@destroy',$record->id],
                                                'method' => 'delete'
                                            ]) !!}
